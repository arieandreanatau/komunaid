...
@section('title', $page->meta_title ?? ($page->title ?? 'Tentang Kami') . ' — KomunaID')
@section('meta_description')
<meta name="description" content="{{ $page->meta_description ?? 'Kenali lebih dekat KomunaID, platform komunitas Indonesia yang menghubungkan member, komunitas, brand, dan perusahaan.' }}">
@endsection
