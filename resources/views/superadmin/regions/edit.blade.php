...
<div class="mb-8">
    ...
    <p class="text-gray-600">Perbarui informasi region</p>
</div>
...
<div class="bg-white rounded-xl shadow-sm p-6 max-w-xl">
    <form method="POST" action="{{ route('superadmin.regions.update', $region) }}">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('description', $region->description) }}</textarea>
            </div>
        ...
        <div class="mt-6 flex space-x-3">
            ...
            <a href="{{ route('superadmin.regions.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg text-sm hover:bg-gray-300">Batal</a>
        </div>
    </form>
</div>
@endsection
