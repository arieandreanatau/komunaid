        ...
        <div id="mobile-sidebar" class="hidden fixed inset-0 z-50">
            ...
            <div class="absolute left-0 top-0 bottom-0 w-64 bg-komuna-navy text-white overflow-y-auto">
                ...
                <nav class="py-3">
                    ...
                    <a href="{{ route('superadmin.cms.blogs') }}" class="flex items-center gap-3 px-5 py-2.5 text-sm {{ request()->routeIs('superadmin.cms.blogs') ? $saActive : 'text-blue-100 hover:bg-white/5 border-r-3 border-transparent' }} transition">Blog</a>
                    <a href="{{ route('superadmin.cms.contact') }}" class="flex items-center gap-3 px-5 py-2.5 text-sm {{ request()->routeIs('superadmin.cms.contact') ? $saActive : 'text-blue-100 hover:bg-white/5 border-r-3 border-transparent' }} transition">Hubungi Kami</a>
                    <a href="{{ route('superadmin.cms.suggestions') }}" class="flex items-center gap-3 px-5 py-2.5 text-sm {{ request()->routeIs('superadmin.cms.suggestions') ? $saActive : 'text-blue-100 hover:bg-white/5 border-r-3 border-transparent' }} transition">Suggestions</a>
