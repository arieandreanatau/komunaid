    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
        <div class="text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('communities.directory') }}" class="bg-white text-emerald-700 px-8 py-3 rounded-xl text-lg font-semibold hover:bg-emerald-50 transition shadow-lg">
                    Jelajahi Komunitas
                </a>
                @guest
                ...
                @else
                    <a href="{{ route('member.dashboard') }}" class="border-2 border-white text-white px-8 py-3 rounded-xl text-lg font-semibold hover:bg-white/10 transition">
                        Dashboard
                    </a>
                @endguest
            </div>
...
<section class="bg-gray-100 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a href="{{ route('communities.directory') }}" class="inline-block bg-emerald-600 text-white px-8 py-3 rounded-xl text-lg font-semibold hover:bg-emerald-700 transition shadow">
