...
@section('content')
<div class="mb-8">
    <h1 class="text-2xl sm:text-3xl font-bold text-komuna-text">Wallet Komunitas</h1>
    <p class="text-komuna-muted">Saldo dan transaksi ledger komunitas Anda.</p>
</div>
...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6 border border-komuna-border-soft">
        <p class="text-sm font-medium text-komuna-muted">Pendapatan Event (Net)</p>
        <p class="text-2xl font-bold text-komuna-blue mt-1">Rp {{ number_format($totalEventIncome, 0, ',', '.') }}</p>
    </div>
    <div class="bg-white rounded-2xl shadow-sm p-6 border border-komuna-border-soft">
        <p class="text-sm font-medium text-komuna-muted">Total Donasi</p>
