...
@section('content')
<div class="mb-8">
    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Wallet</h1>
    <p class="text-gray-600">Saldo dan transaksi internal Anda.</p>
</div>
...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
        ...
        <p class="text-2xl font-bold text-emerald-600 mt-1">Rp {{ number_format($totalCredits, 0, ',', '.') }}</p>
    </div>
    <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
        <p class="text-sm font-medium text-gray-500">Total Keluar</p>
        <p class="text-2xl font-bold text-red-600 mt-1">Rp {{ number_format($totalDebits, 0, ',', '.') }}</p>
    </div>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('member.wallet.history') }}" class="text-emerald-600 text-sm font-medium hover:underline">Lihat Semua</a>
    </div>
