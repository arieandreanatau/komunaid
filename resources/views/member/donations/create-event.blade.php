...
<div class="mb-8">
    <div class="flex items-center gap-3">
        <a href="{{ route('events.show', $event->slug) }}" class="text-gray-400 hover:text-gray-600">&larr;</a>
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Donasi untuk Event</h1>
