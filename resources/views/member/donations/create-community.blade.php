...
<div class="mb-8">
    <div class="flex items-center gap-3">
        <a href="{{ route('communities.detail', $community->slug) }}" class="text-komuna-light-text hover:text-komuna-muted">&larr;</a>
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-komuna-text">Donasi untuk Komunitas</h1>
