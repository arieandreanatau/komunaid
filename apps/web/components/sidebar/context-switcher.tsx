  ...
  return (
    <div className="relative">
      <button
        ...
        type="button"
        onClick={() => isOpen ? handleClose() : handleOpen()}
          className="flex min-h-16 w-full items-center gap-3 rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-left transition-all hover:border-komuna-blue/30 hover:shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-komuna-blue"
        aria-label="Ganti context"
        aria-expanded={isOpen}
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="break-words text-sm font-bold leading-5 text-komuna-navy">{currentName}</p>
          <p className="mt-0.5 break-words text-xs leading-4 text-slate-500">{currentRole}</p>
        </div>
