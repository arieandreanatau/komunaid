    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span>/</span>
          <span className="text-komuna-navy font-medium">My Community Submissions</span>
        </nav>

        <div className="mb-6">
          <h1 className="text-2xl font-bold text-komuna-navy">Pengajuan Komunitas Saya</h1>
          <p className="text-sm text-gray-500 mt-1">Lihat status dan timeline review pengajuan komunitas Anda.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 text-center">
            ...
            <p className="text-gray-500 text-sm mb-6">Anda belum memiliki pengajuan komunitas.</p>
            <Link
