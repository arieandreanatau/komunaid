...
export default function MasterDataOverviewPage() {
  ...
  const [stats, setStats] = useState<MasterDataStats>({ totalCategories: 0, totalLocations: 0, totalRoles: 0 });
  ...
  const fetchStats = useCallback(async () => {
    ...
    try {
      ...
      setStats(data.data || { totalCategories: 0, totalLocations: 0, totalRoles: 0 });
    } catch { /* empty */ }
