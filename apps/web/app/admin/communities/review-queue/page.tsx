...
interface Owner { id: string; name: string; email: string; avatar: string | null; }
...
interface Community {
  ...
  submittedAt: string | null; owner: Owner; categories: Category[]; tags: { id: string; tag: string }[];
...
export default function ReviewQueuePage() {
  ...
  const fetchCommunities = useCallback(async () => {
    ...
    try {
      ...
      const { data } = await api.get("/admin/communities/review-queue", { params });
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div><h1 className="text-2xl font-bold text-komuna-navy">Community Review Queue</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-xl shadow-sm"><p className="text-gray-500">Tidak ada komunitas untuk ditinjau</p></div>
      ) : (
        <>
